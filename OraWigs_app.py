...
Order_page = st.Page("Order.py", title="Order Page")  # create compare page
Tutorial_page = st.Page("Tutorial.py", title="Tutorial Page")  # create compare page
pg = st.navigation([Home_page, Shop_page, Compare_page, Order_page, Tutorial_page])  # make a navigation for the pages
